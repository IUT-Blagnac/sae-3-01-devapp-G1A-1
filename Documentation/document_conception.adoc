...
image::images/DCC_Recherche.png[DCC_Recherche, 100%]
...
image::images/DCC_Ajout_Au_Panier.png[DCC_Ajout_Au_Panier,100%]
...
image::images/DCC_Visualisation_du_produit.png[DCC_Visualisation_du_produit,100%]
