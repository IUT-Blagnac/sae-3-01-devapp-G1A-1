...
image::images/DCC_Recherche.png[DCC_Recherche, 50%]
...
image::images/DCC_Ajout_Au_Panier.png[DCC_Ajout_Au_Panier,30%]
...
image::images/DCC_Visualisation_du_produit.png[DCC_Visualisation_du_produit,50%]
