...
image::images/doc_user_web/from_index_to_connexion.png

(1 : bouton compte et panier)

image::images/doc_user_web/form_conn.png

(2 : formulaire de connexion)

image::images/doc_user_web/err_log.png

(3 : erreur identifiant incorrect)

image::images/doc_user_web/err_mdp.png

(4 : erreur mot de passe incorrect)

image::images/doc_user_web/compte_desa.png
