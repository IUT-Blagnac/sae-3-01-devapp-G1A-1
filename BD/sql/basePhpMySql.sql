DROP TABLE `ACommande`, `AdressePostale`, `ARegarde`, `Avis`, `Carte_AE`, `Carte_EU`, `Categorie`, `Client`, `Commande`, `Comporte`, `Contient`, `Employe`, `Image`, `infoPaiement`, `Marque`, `MethodePaiement`, `Paypal`, `Produit`, `Promotion`;
