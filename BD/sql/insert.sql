...
INSERT INTO Produit (idCategorie, nomProduit, prix, descriptionProduit) VALUES (9, 'Acer Intel Core i9-13900K - Processeur', 599.99, 'processeur haut de gamme Intel Core i9');
INSERT INTO Produit (idCategorie, nomProduit, prix, descriptionProduit) VALUES (6, 'MSI MacBook Pro 16 - PC portable', 2499.99, 'PC portable haute performance pour professionnels');
INSERT INTO Produit (idCategorie, nomProduit, prix, descriptionProduit) VALUES (4, 'Corsair Corsair 4000D - Boitier PC', 89.99, 'Boitier PC spacieux avec bonne ventilation');
INSERT INTO Produit (idCategorie, nomProduit, prix, descriptionProduit) VALUES (7, 'Corsair HyperX Fury 8GB - Mémoire', 39.99, 'Mémoire DDR4 de 8GB pour PC gamer');
INSERT INTO Produit (idCategorie, nomProduit, prix, descriptionProduit) VALUES (3, 'MSI Z590 AORUS - Carte Mère', 249.99, 'Carte mère compatible Intel Z590');
INSERT INTO Produit (idCategorie, nomProduit, prix, descriptionProduit) VALUES (3, 'NZXT TUF Gaming X570 - Carte Mère', 179.99, 'Carte mère AMD X570 pour PC gamer');
INSERT INTO Produit (idCategorie, nomProduit, prix, descriptionProduit) VALUES (6, 'Acer XPS 13 - PC portable', 1499.99, 'PC portable léger et performant');
INSERT INTO Produit (idCategorie, nomProduit, prix, descriptionProduit) VALUES (5, 'MSI GTX 1660 Ti - Carte graphique', 299.99, 'Carte graphique GTX 1660 Ti pour gaming');
INSERT INTO Produit (idCategorie, nomProduit, prix, descriptionProduit) VALUES (7, 'Kingston Ripjaws V 32GB - Mémoire', 119.99, 'Mémoire DDR4 32GB pour gaming');
INSERT INTO Produit (idCategorie, nomProduit, prix, descriptionProduit) VALUES (5, 'Acer Radeon RX 7900 XT - Carte graphique', 1299.99, 'Carte graphique haut de gamme Radeon RX 7900');
INSERT INTO Produit (idCategorie, nomProduit, prix, descriptionProduit) VALUES (6, 'Asus MacBook Pro 16 - PC portable', 2499.99, 'PC portable haute performance Asus');
INSERT INTO Produit (idCategorie, nomProduit, prix, descriptionProduit) VALUES (9, 'Razer Intel Core i7-12700K - Processeur', 399.99, 'Processeur Intel Core i7-12700K');
INSERT INTO Produit (idCategorie, nomProduit, prix, descriptionProduit) VALUES (8, 'AMD NZXT Aer P - Ventilateur boitier', 49.99, 'Ventilateur boitier de 120mm pour refroidissement');
INSERT INTO Produit (idCategorie, nomProduit, prix, descriptionProduit) VALUES (4, 'Sapphire MasterBox Q300L - Boitier PC', 79.99, 'Boitier PC compact et fonctionnel');
INSERT INTO Produit (idCategorie, nomProduit, prix, descriptionProduit) VALUES (8, 'Corsair Corsair LL120 RGB - Ventilateur boitier', 59.99, 'Ventilateur RGB de 120mm');
INSERT INTO Produit (idCategorie, nomProduit, prix, descriptionProduit) VALUES (2, 'Corsair CoolerPro 120 - Watercooling', 99.99, 'Système de refroidissement liquide pour CPU');
INSERT INTO Produit (idCategorie, nomProduit, prix, descriptionProduit) VALUES (4, 'Kingston Phanteks Eclipse P400A - Boitier PC', 89.99, 'Boitier PC avec panneaux en mesh et bonne ventilation');
INSERT INTO Produit (idCategorie, nomProduit, prix, descriptionProduit) VALUES (2, 'Acer HydroBoost 360 - Watercooling', 149.99, 'Système de watercooling 360mm pour CPU');
INSERT INTO Produit (idCategorie, nomProduit, prix, descriptionProduit) VALUES (2, 'Corsair XtremeFlow 240 - Watercooling', 119.99, 'Système de watercooling 240mm');
INSERT INTO Produit (idCategorie, nomProduit, prix, descriptionProduit) VALUES (7, 'MSI Trident Z RGB 64GB - Mémoire', 249.99, 'Mémoire DDR4 64GB pour gaming');
INSERT INTO Produit (idCategorie, nomProduit, prix, descriptionProduit) VALUES (5, 'Intel GeForce RTX 4080 - Carte graphique', 1599.99, 'Carte graphique haut de gamme RTX 4080');
INSERT INTO Produit (idCategorie, nomProduit, prix, descriptionProduit) VALUES (3, 'Asus Z490 Pro WiFi - Carte Mère', 249.99, 'Carte mère avec support WiFi et Intel Z490');
INSERT INTO Produit (idCategorie, nomProduit, prix, descriptionProduit) VALUES (8, 'MSI Be Quiet! Pure Wings 2 - Ventilateur boitier', 29.99, 'Ventilateur PC silencieux de 120mm');
INSERT INTO Produit (idCategorie, nomProduit, prix, descriptionProduit) VALUES (3, 'Intel Z590 AORUS - Carte Mère', 349.99, 'Carte mère Intel Z590 AORUS');
INSERT INTO Produit (idCategorie, nomProduit, prix, descriptionProduit) VALUES (6, 'Razer MacBook Pro 16 - PC portable', 2499.99, 'PC portable performant Razer');
INSERT INTO Produit (idCategorie, nomProduit, prix, descriptionProduit) VALUES (7, 'Gigabyte Ripjaws V 32GB - Mémoire', 119.99, 'Mémoire DDR4 32GB');
INSERT INTO Produit (idCategorie, nomProduit, prix, descriptionProduit) VALUES (2, 'MSI XtremeFlow 240 - Watercooling', 129.99, 'Watercooling 240mm');
INSERT INTO Produit (idCategorie, nomProduit, prix, descriptionProduit) VALUES (4, 'Kingston Corsair 4000D - Boitier PC', 109.99, 'Boitier PC de grande capacité');
INSERT INTO Produit (idCategorie, nomProduit, prix, descriptionProduit) VALUES (2, 'Kingston UltraCool 240 - Watercooling', 89.99, 'Système de refroidissement liquide 240mm');
INSERT INTO Produit (idCategorie, nomProduit, prix, descriptionProduit) VALUES (3, 'Sapphire ROG Strix B550 - Carte Mère', 179.99, 'Carte mère AMD B550 ROG Strix');
INSERT INTO Produit (idCategorie, nomProduit, prix, descriptionProduit) VALUES (4, 'Asus Corsair 4000D - Boitier PC', 119.99, 'Boitier PC solide avec bonne ventilation');
INSERT INTO Produit (idCategorie, nomProduit, prix, descriptionProduit) VALUES (7, 'Gigabyte HyperX Fury 8GB - Mémoire', 39.99, 'Mémoire DDR4 8GB pour PC');
INSERT INTO Produit (idCategorie, nomProduit, prix, descriptionProduit) VALUES (2, 'Acer UltraCool 240 - Watercooling', 99.99, 'Système de watercooling 240mm');
INSERT INTO Produit (idCategorie, nomProduit, prix, descriptionProduit) VALUES (9, 'Razer Intel Core i9-13900K - Processeur', 599.99, 'Processeur Intel Core i9-13900K');
INSERT INTO Produit (idCategorie, nomProduit, prix, descriptionProduit) VALUES (2, 'Sapphire XtremeFlow 240 - Watercooling', 119.99, 'Watercooling 240mm');
INSERT INTO Produit (idCategorie, nomProduit, prix, descriptionProduit) VALUES (6, 'Kingston XPS 13 - PC portable', 1599.99, 'PC portable performant Kingston');
INSERT INTO Produit (idCategorie, nomProduit, prix, descriptionProduit) VALUES (6, 'Corsair Predator Helios 300 - PC portable', 1699.99, 'PC portable gaming Corsair');
INSERT INTO Produit (idCategorie, nomProduit, prix, descriptionProduit) VALUES (3, 'Kingston Z490 Pro WiFi - Carte Mère', 249.99, 'Carte mère Kingston Z490 avec WiFi');
INSERT INTO Produit (idCategorie, nomProduit, prix, descriptionProduit) VALUES (7, 'Acer Trident Z RGB 64GB - Mémoire', 249.99, 'Mémoire DDR4 64GB pour PC gaming');
INSERT INTO Produit (idCategorie, nomProduit, prix, descriptionProduit) VALUES (4, 'Acer Corsair 4000D - Boitier PC', 99.99, 'Boitier PC avec bonne gestion de l’airflow');
INSERT INTO Produit (idCategorie, nomProduit, prix, descriptionProduit) VALUES (8, 'Corsair NZXT Aer P - Ventilateur boitier', 39.99, 'Ventilateur PC efficace de 120mm');
INSERT INTO Produit (idCategorie, nomProduit, prix, descriptionProduit) VALUES (8, 'Asus Be Quiet! Pure Wings 2 - Ventilateur boitier', 19.99, 'Ventilateur de boitier silencieux');
INSERT INTO Produit (idCategorie, nomProduit, prix, descriptionProduit) VALUES (6, 'MSI ROG Zephyrus G14 - PC portable', 1499.99, 'PC portable haute performance pour gaming');
INSERT INTO Produit (idCategorie, nomProduit, prix, descriptionProduit) VALUES (9, 'Acer AMD Ryzen 5 5600X - Processeur', 299.99, 'Processeur AMD Ryzen 5 5600X');
INSERT INTO Produit (idCategorie, nomProduit, prix, descriptionProduit) VALUES (8, 'Gigabyte Corsair LL120 RGB - Ventilateur boitier', 59.99, 'Ventilateur RGB Corsair 120mm');
INSERT INTO Produit (idCategorie, nomProduit, prix, descriptionProduit) VALUES (5, 'Asus GeForce RTX 4080 - Carte graphique', 1599.99, 'Carte graphique Asus GeForce RTX 4080');
INSERT INTO Produit (idCategorie, nomProduit, prix, descriptionProduit) VALUES (3, 'Sapphire Z590 AORUS - Carte Mère', 329.99, 'Carte mère Intel Z590 AORUS');
INSERT INTO Produit (idCategorie, nomProduit, prix, descriptionProduit) VALUES (4, 'Corsair Phanteks Eclipse P400A - Boitier PC', 99.99, 'Boitier PC Phanteks Eclipse P400A');
INSERT INTO Produit (idCategorie, nomProduit, prix, descriptionProduit) VALUES (8, 'Sapphire Cooler Master MasterFan - Ventilateur boitier', 49.99, 'Ventilateur de boitier Cooler Master 120mm');
INSERT INTO Produit (idCategorie, nomProduit, prix, descriptionProduit) VALUES (9, 'NZXT Intel Core i7-12700K - Processeur', 399.99, 'Processeur Intel Core i7-12700K');
