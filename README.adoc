...
- **link:Droit/fiche_de_conseils_juridiques_et_de_sécurité_G1A-1.pdf[Synthèse de droit]** : Différentes mentions légales et actions mise en œuvre concernant la protection des données
