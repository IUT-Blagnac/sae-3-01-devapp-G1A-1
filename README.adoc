...
| OK, juste qq fautes. Pensez à me faire passer l'ODJ de la semaine prochaine, vous pouvez mettre à l'ODJ une clé de répartition des notes de Com et de Projet en cas de disparité de travail dans l'équipe.
| 2,75/3
|===
