...
| Site Web "BuildMyPC" | URL pour consulter le site | V0.1.2 | http://193.54.227.164/~SOON/index.php[SOON - Lien vers le site web extérieur à l'IUT]
...
- Version actuelle :https://github.com/IUT-Blagnac/sae-3-01-devapp-G1A-1/releases/tag/V1.0[v1.0]
...
- Plan de test : link:tests/document_test_web.adoc[Disponible ici]
...
| Semaine 47  | https://github.com/IUT-Blagnac/sae-3-01-devapp-G1A-1/blob/master/Communication/Ordre%20du%20jour%20reunion%20du%2019-11-2024.pdf[Lien vers le CR]
